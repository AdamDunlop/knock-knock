...
Comedian.create(first_name:"Adam", last_name: "Dunlop", description: "chomp chomp", email: "a@d.com", picture_url:"http://s16.postimg.org/idsgi3rc5/doge.jpg", password:1234, joke:"Knock, knock. Who's there? Europe. Europe, who? No, you're a poo!")
Comedian.create(first_name:"Evert", last_name: "R", email: "e@r.com", picture_url:"http://s16.postimg.org/idsgi3rc5/doge.jpg", password:1234, joke: "Knock, knock. Who's there? To. To who? It's \"<em>to whom</em>\"")
Comedian.create(first_name:"Doge", last_name: "Dog", email: "d@d.com", picture_url:"http://s16.postimg.org/idsgi3rc5/doge.jpg", password:1234, joke: "What is it called when a cat wins a dog show? A CAT-HAS-TROPHY!")
Comedian.create(first_name:"Jerry", last_name: "Seinfield", email: "j@s.com", picture_url:"https://thestuckcreative.files.wordpress.com/2013/03/jerry-seinfeld.jpg", password:1234, joke: "Dark humor is like food, some people dont have any.")
Comedian.create(first_name:"Kevin", last_name:"Hart", email:"k@h.com", description: "Kevin Hart is the best", password: 1234, picture_url:"http://financialjuneteenth.com/wp-content/uploads/2014/06/kevin1.jpg", joke:"If I had a dollar for every time a girl told me I was unattractive, they'd eventually find me attractive.")
...
Comedian.create(first_name:"Weird", last_name:"Al", email:"w@a.com", description: "Something about Weird Al", password: 1234, picture_url:"http://static.tvtropes.org/pmwiki/pub/images/weirdal.jpg", joke: "Knock, knock. Who's there? Art. Art Who? R2-D2.")
